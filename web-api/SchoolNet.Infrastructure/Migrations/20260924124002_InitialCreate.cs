        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    SClassId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSubjects_SchoolClasses_SClassId",
                        column: x => x.SClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abwesenheits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Abwesenheits_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Abwesenheits_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Value = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Homeworks_ClassSubjects_ClassSubjectId",
                        column: x => x.ClassSubjectId,
                        principalTable: "ClassSubjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Abwesenheits_Id",
                table: "Abwesenheits",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_Abwesenheits_ScheduleId",
                table: "Abwesenheits",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_Abwesenheits_StudentId",
                table: "Abwesenheits",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSubjects_Id",
                table: "ClassSubjects",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSubjects_SClassId",
                table: "ClassSubjects",
                column: "SClassId");
